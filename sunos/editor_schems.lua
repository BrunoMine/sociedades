...
-- Lista de larguras
local lista_de_larguras = {"3", "5", "7", "9", "13", "15"}
local lista_de_larguras_i = {["3"]=1, ["5"]=2, ["7"]=3, ["9"]=4, ["13"]=5, ["15"]=6}
...
local acessar_menu = function(name)
	...
	local formspec = "size[10,10]"
		...
		.."button_exit[6,3.8;3,1;deletar;Deletar]"
		
		.."label[0,5.2;Criar nova estrutura]"
		.."field[0.3,6.3;8,1;nome_novo;Nome da estrutura;]"
		.."label[8,5.5;Largura]"
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname == "sunos:editor_schems" then 
		...
		if fields.carregar then
			...
			minetest.chat_send_all(dump(arq))
			minetest.place_schematic({x=pos.x+2, y=pos.y, z=pos.z}, minetest.get_modpath("sunos").."/schems/"..arq, 0, nil, true)
