...
minetest.register_node("sunos:bau_loja", {
	...
	on_receive_fields = function(pos, formname, fields, sender)
		if fields.trocar_madeira then
			-- Tenta trocar
			if sunos.trocar_itens(sender, {"default:tree"}, {"default:apple 2"}) == false then
		...
		elseif fields.trocar_pedra then
			-- Tenta trocar
			if sunos.trocar_itens(sender, {"default:stonebrick"}, {"default:apple 2"}) == false then
				return minetest.chat_send_player(sender:get_player_name(), S("Precisa do item para trocar"))
			else
				return minetest.chat_send_player(sender:get_player_name(), S("Troca feita"))
			end
		elseif fields.trocar_ouro then
			-- Tenta trocar
			if sunos.trocar_itens(sender, {"default:gold_ingot"}, {"default:apple 10"}) == false then
				return minetest.chat_send_player(sender:get_player_name(), S("Precisa do item para trocar"))
			else
				return minetest.chat_send_player(sender:get_player_name(), S("Troca feita"))
			end
		elseif fields.trocar_ferro then
			-- Tenta trocar
			if sunos.trocar_itens(sender, {"default:steel_ingot"}, {"default:apple 6"}) == false then
				return minetest.chat_send_player(sender:get_player_name(), S("Precisa do item para trocar"))
			else
				return minetest.chat_send_player(sender:get_player_name(), S("Troca feita"))
			end
		elseif fields.trocar_carvao then
			-- Tenta trocar
			if sunos.trocar_itens(sender, {"default:coal_lump"}, {"default:apple 2"}) == false then
				return minetest.chat_send_player(sender:get_player_name(), S("Precisa do item para trocar"))
			else
				return minetest.chat_send_player(sender:get_player_name(), S("Troca feita"))
			end
		elseif fields.trocar_vidro then
			-- Tenta trocar
			if sunos.trocar_itens(sender, {"default:glass"}, {"default:apple 2"}) == false then
				return minetest.chat_send_player(sender:get_player_name(), S("Precisa do item para trocar"))
			else
				return minetest.chat_send_player(sender:get_player_name(), S("Troca feita"))
			end
