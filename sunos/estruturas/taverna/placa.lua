...
minetest.register_node("sunos:taverna_placa", {
	...
	tiles = {
		...
		"default_wood.png^sunos_taverna_placa.png", -- Baixo
		"default_wood.png^sunos_taverna_placa.png", -- Lado direito
		"default_wood.png^sunos_taverna_placa.png", -- Lado esquerda
		"default_wood.png^sunos_taverna_placa.png", -- Fundo
		"default_wood.png^sunos_taverna_placa.png" -- Frente
	},
	inventory_image = "default_wood.png^sunos_taverna_placa_inv.png^[makealpha:255,127,127",
	wield_image = "default_wood.png^sunos_taverna_placa_inv.png^[makealpha:255,127,127",
	paramtype = "light",
	paramtype2 = "facedir",
	walkable = false,
	selection_box = {
